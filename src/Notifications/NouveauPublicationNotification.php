...
class NouveauPublicationNotification
{
    ...
    public function notify()
    {
      ...
      ->setUsername('hayfa.boughoufa@esprit.tn')
      ->setPassword('213JFT5198');
      ...
      ->setFrom(['hayfa.boughoufa@esprit.tn' => 'GETAWAYwebsite notifier'])
      ->setTo(['elkhater.elkharouf@esprit.tn'])
